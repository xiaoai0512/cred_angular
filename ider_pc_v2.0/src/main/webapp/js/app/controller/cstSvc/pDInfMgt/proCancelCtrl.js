...
define(function(require) {
	...
	//产品注销
	webApp.controller('proCancelCtrl', function($scope, $stateParams,
		...
		$scope.cancelMdm = function() {
			...
			$scope.cancelParam.customerNo = $scope.itemObj.customerNo;
			$scope.cancelParam.productObjectCode = $scope.itemObj.productObjectCode;
			$scope.cancelParam.operationMode = $scope.itemObj.operationMode;
			jfRest.request('proCancel', 'saveCanel', $scope.cancelParam ).then(function(data) {
				if (data.returnCode == '000000') {
