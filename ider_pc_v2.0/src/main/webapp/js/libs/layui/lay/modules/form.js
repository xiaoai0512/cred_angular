			...
			d = {
				select: function() {
							...
							if (!o) {
								...
								f && m.on("keyup", w).on("blur", function(i) {
									...
									var e = i(this),
										a = e.attr("lay-value"),
										n = h.attr("lay-filter");
									return !e.hasClass(c) && (e.hasClass("layui-select-tips") ? m.val("") : (m.val(e.text()), e.addClass(r)),
					...
					f.each(function(e, l) {
						...
						var v = "string" == typeof s.attr("lay-search"),
							...
							m = i(['<div class="' + (v ? "" : "layui-unselect ") + a + (o ? " layui-select-disabled" : "") + '">',
								'<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' +
								(v ? "" : "readonly") + ' class="layui-input' + (v ? "" : " layui-unselect") + (o ? " " + c : "") + '">',
								'<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ?
									...
									return layui.each(e, function(e, a) {
										0 !== e || a.value ? "optgroup" === a.tagName.toLowerCase() ? i.push("<dt>" + a.label + "</dt>") : i
											.push('<dd lay-value="' + a.value + '" class="' + (d === a.value ? r : "") + (a.disabled ? " " + c :
				...
				checkbox: function() {
					...
					t.each(function(t, n) {
						...
						var d = l.next("." + o[0]),
							f = i(['<div class="layui-unselect ' + o[0] + (n.checked ? " " + o[1] : "") + (u ?
									" layui-checkbox-disbaled " + c : "") + '" lay-skin="' + (s || "") + '">', {
				...
				radio: function() {
					...
					a.each(function(a, l) {
						var s = i(this),
							...
							u = this.disabled;
						if ("string" == typeof s.attr("lay-ignore")) return s.show();
						var o = i(['<div class="layui-unselect ' + e + (l.checked ? " " + e + "ed" : "") + (u ?
